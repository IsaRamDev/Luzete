    ...
    <div className="bg-gray-100 py-16">
      <div className="container mx-auto px-6">
        ...
        <div className="bg-white rounded-lg shadow-md p-12">
          ...
          <h2 className="text-2xl font-bold text-[#001F54] mt-6 mb-4">1. Datos Recopilados</h2>
          ...
          <h2 className="text-2xl font-bold text-[#001F54] mt-6 mb-4">2. Uso de la Información</h2>
          <p className="text-gray-700 leading-relaxed mb-4">
          ...
          <h2 className="text-2xl font-bold text-[#001F54] mt-6 mb-4">3. Protección de Datos</h2>
          <p className="text-gray-700 leading-relaxed mb-4">
          ...
          <h2 className="text-2xl font-bold text-[#001F54] mt-6 mb-4">4. Compartición de Información</h2>
          <p className="text-gray-700 leading-relaxed mb-4">
          ...
          <h2 className="text-2xl font-bold text-[#001F54] mt-6 mb-4">5. Derechos del Titular de los Datos</h2>
          <p className="text-gray-700 leading-relaxed mb-4">
          ...
          <p className="text-gray-700 leading-relaxed">
            Correo electrónico: <a href="mailto:privacidad@luzetefashion.com" className="text-[#001F54] hover:underline">privacidad@luzetefashion.com</a>
          </p>

          <h2 className="text-2xl font-bold text-[#001F54] mt-6 mb-4">6. Modificaciones al Aviso de Privacidad</h2>
          <p className="text-gray-700 leading-relaxed mb-4">
          ...
          <h2 className="text-2xl font-bold text-[#001F54] mt-6 mb-4">7. Contacto</h2>
          <p className="text-gray-700 leading-relaxed mb-4">
