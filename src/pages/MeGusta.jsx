    ...
    <div className="sm:mb-20 mb-10 sm:mt-32 mt-20 px-4 sm:px-10 lg:px-20" id="descuentos">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-3 sm:gap-6">
        {descuentos.map((item) => (
          ...
          >
            {/* Icono de eliminar */}
            <div
              className="absolute bottom-8 right-8 text-red-600"
              onClick={(e) => {
                e.stopPropagation();
      ...
      {productoAEliminar && (
        <div className="fixed inset-0 bg-black bg-opacity-30 flex items-center justify-center z-50">
          <div className="bg-white p-10 rounded-lg shadow-md w-11/12 max-w-sm text-center">
            <p className="mb-16 text-[#222] text-lg font-medium">
              ¿Estás seguro de que quieres eliminar este producto?
            </p>
            <div className="flex justify-center gap-20">
              <button
                className="bg-gradient-to-r from-[#7400ad] to-[#d80495] text-white px-6 py-2 rounded-full"
