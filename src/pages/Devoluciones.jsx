...
function TerminosYCondiciones() {
  return (
    <div className="bg-gray-100 sm:py-16 py-8">
      <div className="container mx-auto sm:px-6 px-3 text-center">
        <h1 className="sm:text-4xl text-xl font-bold text-center text-[#7400ad] sm:mb-16 mb-5">
          Devoluciones
        </h1>
        <div className="bg-white rounded-lg shadow-md sm:text-base text-sm sm:p-12 p-6 border border-gray-200">
          <p className="sm:text-lg text-gray-900 leading-relaxed mb-12">
            Tienes alguna pregunta o necesitas haceruna devolucion? No dudes en contactarnos.
            <br />
            <br />
            <strong>¡Estamos aquí para ayudarte!</strong>
          </p>
          <p className="sm:text-lg text-gray-900 leading-relaxed mb-12">
            Para ofrecerte un servicio personalizado, te recomendamos que nos contactes a través de nuestro número de teléfono. Nuestro equipo estará encantado de asistirte y resolver cualquier duda que puedas tener.
          </p>
          <button
            href="#"
